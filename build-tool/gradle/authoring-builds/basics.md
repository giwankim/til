...
Across all projects in the build, tasks form a DAG.
...
```mermaid
flowchart LR
    id1[1 INITIALIZATION PHASE] --> id2[2 CONFIGURATION PHASE] --> id3[3 EXECUTION PHASE]
```
...
![build-lifecycle](../../../assets/build-tool/gradle/authoring-builds/build-lifecycle.png)
...
In the __configuration phase__, Gradle adds tasks and other properties to the projects found by the initialization phase.

### Phase 3. Execution

In the __execution phase__, Gradle runs tasks.
...
![settings-file](../../../assets/build-tool/gradle/authoring-builds/settings-file.png)
